...
(function($) {
	...
	$.anythingSlider = function(el, options) {
		...
		base.buildNavigation = function() {
			if (o.buildNavigation && (base.pages > 1)) {
				...
				base.$items.filter(':not(.cloned)').each(function(i) {
					...
					t = ((index === 1) ? 'first' : '') + ((index === base.pages) ? 'last' : '') + ((index === 2) ? 'second' : '') + ((index === 3) ? 'third' : '') + ((index === 4) ? 'fourth' : '');
					w = ((index === 1) ? 'first' : '') + ((index === base.pages) ? 'last' : '') + ((index === 2) ? 'second' : '') + ((index === 3) ? 'third' : '') + ((index === 4) ? 'fourth' : '');
					$a = $('<a href="#" id="' + w + '"></a>').addClass('panel' + index).wrap('<li class="' + t + '" />');
		...
		base.buildNextBackButtons = function() {
			base.$forward = $('<span class="arrow forward" id="nextslide"><a href="#"><span>' + o.forwardText + '</span></a></span>');
			base.$back = $('<span class="arrow back" id="prevslide"><a href="#"><span>' + o.backText + '</span></a></span>');
